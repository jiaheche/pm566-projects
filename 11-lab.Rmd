...
- There are 12,854 rows and 9 columns.
...
- Date is from 2020-01-21 to 2020-11-03, cases is from 1 to 973,517, deaths is from 0 to 33,198.
...
- Some new cases/deaths values are <0 and are excluded.
...
- There is an overall positive association between population density and new deaths per 100k.
...
- The time delay is about 2 weeks.
...
- The CFRs for most states have decreased since May 1.
